...
var ttr = (function (exports) {
  ...
  function array(param) {
    ...
    return /* Decoder */[(function (value) {
                ...
                if (typeof match === "number" || match.tag !== 3) {
                  ...
                  try {
                    return /* Ok */__(0, [map$7(parse, match[0])]);
                  }
                  catch (raw_exn){
                    var exn = internalToOCamlException(raw_exn);
                    if (exn[0] === ParseFail) {
  ...
  function incrementChutzpah(player) {
    return /* record */[
            /* name */player[/* name */0],
            /* chutzpah */player[/* chutzpah */1] + 1 | 0
          ];
  }

  function decrementChutzpah(player) {
    return /* record */[
            /* name */player[/* name */0],
            /* chutzpah */player[/* chutzpah */1] - 1 | 0
          ];
  ...
  function setChutzpah(player, amt) {
    return /* record */[
            /* name */player[/* name */0],
            /* chutzpah */amt
          ];
    ...
    if (typeof param$$1 === "number") {
      switch (param$$1) {
        case 0 : 
            return /* tuple */[
                    /* record */[
                      /* player */incrementChutzpah(model[/* player */0]),
                      /* tile */model[/* tile */1]
                    ],
                    none
                  ];
        case 1 : 
            return /* tuple */[
                    /* record */[
                      /* player */decrementChutzpah(model[/* player */0]),
                      /* tile */model[/* tile */1]
                    ],
                    none
                  ];
        case 2 : 
            return /* tuple */[
                    /* record */[
                      /* player */setChutzpah(model[/* player */0], 0),
                      /* tile */model[/* tile */1]
                    ],
                    none
                  ];
      ...
      return /* tuple */[
              /* record */[
                /* player */setChutzpah(model[/* player */0], param$$1[0]),
                /* tile */model[/* tile */1]
              ],
              none
            ];
  ...
  function view_button(title$$1, msg$$1) {
  ...
  function view_player(player) {
    return div$2(undefined, undefined, /* [] */0, /* :: */[
                h1(undefined, undefined, /* [] */0, /* :: */[
                      text$1(player[/* name */0]),
                      /* [] */0
                    ]),
                /* :: */[
                  h2(undefined, undefined, /* [] */0, /* :: */[
                        text$1(String(player[/* chutzpah */1])),
                        /* [] */0
                      ]),
                  /* [] */0
                ]
                        ...
                        /* :: */[
                          ...
                          /* :: */[
                            ...
                            /* :: */[
                              br(/* [] */0),
                              /* :: */[
                                model[/* player */0][/* chutzpah */1] !== 0 ? view_button("Reset", /* Reset */2) : noNode$1,
                                /* [] */0
                              ]
                            ]
                          ]
  ...
  function main$1(param$$1, param$1) {
  ...
  exports.incrementChutzpah = incrementChutzpah;
  exports.decrementChutzpah = decrementChutzpah;
  exports.setChutzpah = setChutzpah;
  ...
  exports.view_player = view_player;
  exports.view = view;
  exports.main = main$1;
